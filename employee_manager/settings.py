...
SECRET_KEY = 'django-insecure-64lldq5x9d2=p*gc0*)$m130bs@evhk(bloiusg)_z54(c--uu'
...
AUTH_USER_MODEL = 'mainapp.User'  # Replace 'mainapp' with your actual app name
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Used in production
